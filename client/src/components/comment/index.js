        ...
        <div className="comment-container">
            ...
            <div className="ms-2">
                ...
                <div className="comment-container__reply-action ms-3">
                    <a className="position-relative" onMouseEnter={() => setShowEmoji(true)} onMouseLeave={() => setShowEmoji(false)}>
                            ...
                            <>
                                <div className="comment-container__reply">
                                    ...
                                    <span style={{fontWeight: "600"}}>
                                        { !showRepliedComment ? reply?.length  + " Phản hồi" : "Ẩn phản hồi"}
                                    </span>
                                </div>
                                { showRepliedComment && reply.map(reply => <RepliedComment data={reply}/>)}
                            </>
                        }
