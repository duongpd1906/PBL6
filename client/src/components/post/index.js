        ...
        <div className="post-container">
            <div className="mx-3">
                <div className="d-flex align-items-center">
                    ...
                    <div className="ms-3">
                        <a className="user-name" href="#">Lotte Cinema</a>
                        <br/>
            ...
            <div className="post-container__bottom mx-3">
                ...
                <div className="post-container__bottom__action">
                    <div className="col-4" onMouseEnter={() => setShowEmoji(true)} onMouseLeave={() => setShowEmoji(false)}>
                ...
                <div className="post-container__bottom__comment col-12">
                    <img className="img-circle" src="https://scontent.fdad1-2.fna.fbcdn.net/v/t39.30808-6/280374790_1477115089370427_2274356777150785265_n.jpg?_nc_cat=102&ccb=1-7&_nc_sid=09cbfe&_nc_ohc=BGiT7grLdloAX9IRJ_q&_nc_ht=scontent.fdad1-2.fna&oh=00_AT9cSGOCa9XgxlLhOaqjXNYXm19qGb65c2eSuzlvgQuLGQ&oe=63279F08"/>
                    <input placeholder="Viết bình luận..."/>
                </div>
                {showComment && listComment.map((comment) => <Comment data={comment}/>) }
            </div>
        </div>
