    ...
    return (
        ...
        >
            <Menu className="side-bar-container">
                ...
                <Menu.Item key="3"className="item" icon={<UsergroupAddOutlined className="icon"/>}>
                    <p>Bạn bè</p>
                </Menu.Item>
                <Menu.Item key="4"className="item" icon={<BookOutlined className="icon"/>}>
                    <p>Đã lưu</p>
                </Menu.Item>
                <Menu.Item key="5"className="item" icon={<HistoryOutlined className="icon"/>}>
                    <p>Lịch sử</p>
                </Menu.Item>
            </Menu>
        </Sider>
